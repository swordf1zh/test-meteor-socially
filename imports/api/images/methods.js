...
import { dataURLToBlob, dataURItoBlob, blobToArrayBuffer } from './helpers';
 ...
 */
export function ERROR_HERE_upload(dataUrl, name, resolve, reject) {
  // convert to Blob
...
export function upload(dataUrl, name, resolve, reject) {
  ...
  const file = _.pick(blob, 'type', 'size');
  file.name = name;
